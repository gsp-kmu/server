...
class ResultService {
    CalculateResult(user1:GameUser, user2:GameUser){
        const user1_number = this.CalculateNumber(user1.numberHold);
        const user2_number = this.CalculateNumber(user2.numberHold);
    ...
    CalculateNumber(numberHold:Array<number>){
